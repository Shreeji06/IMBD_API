...
class UserReview(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return ReviewList.objects.filter(review_user__username=username)
...
class ReviewCreate(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        review_queryset = ReviewList.objects.filter(
...
class ReviewList1(generics.ListAPIView):
    ...
    def get_queryset(self):
        pk = self.kwargs['pk']
        return ReviewList.objects.filter(watchlist=pk)
...
class WatchDetailAV(APIView):
    ...
    def get(self, request, pk):
        try:
            ...
            return Response({'Error':  'ops not found'}, status=status.HTTP_404_NOT_FOUND)
...
#             return Response({'Error':  'ops movie not found'}, status=status.HTTP_404_NOT_FOUND)
